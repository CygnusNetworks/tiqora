...
def _selector_from_in(body: ErasureSelectorIn | None) -> ErasureSelector:
    ...
    return ErasureSelector(
        ...
        login_regex_negate=body.login_regex_negate,
        customer_id_regex=body.customer_id_regex,
        customer_id_regex_negate=body.customer_id_regex_negate,
        email_regex=body.email_regex,
        email_regex_negate=body.email_regex_negate,
