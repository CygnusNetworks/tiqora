...
const LINKS: { to: string; labelKey: string }[] = [
  ...
  { to: "/admin/customer-user-groups", labelKey: "admin.nav.customerUserGroups" },
  ...
  { to: "/admin/template-attachments", labelKey: "admin.nav.templateAttachments" },
  { to: "/admin/attachments", labelKey: "admin.nav.attachments" },
  { to: "/admin/queue-templates", labelKey: "admin.nav.queueTemplates" },
  { to: "/admin/queue-auto-responses", labelKey: "admin.nav.queueAutoResponses" },
