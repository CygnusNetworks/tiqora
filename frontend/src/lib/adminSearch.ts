...
export const ADMIN_PAGES: AdminPageEntry[] = [
  ...
  },
  {
    ...
    group: "communication",
    nameKey: "admin.nav.mailAccounts",
    descriptionKey: "admin.pageDescriptions.mailAccounts",
  ...
  },
  {
    ...
    group: "communication",
    nameKey: "admin.nav.oauth2Tokens",
    descriptionKey: "admin.pageDescriptions.oauth2Tokens",
    keywords: [
      "oauth",
      "oauth2",
      "xoauth2",
  ...
  // the health board first.
  {
    ...
    route: "/admin/system",
    group: "system",
    nameKey: "admin.nav.systemInfo",
    descriptionKey: "admin.pageDescriptions.systemInfo",
    keywords: [
      "system",
      "info",
      "status",
